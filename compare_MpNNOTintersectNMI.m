...
function u = compare_MpNNOTintersectCpG(i1, i2)

for ich=i1:i2

filename = sprintf('../SkirmantasData/AllCentresCh37/allsubsequencesCh%iMpNNOTintersectNMI147.mat',ich);
...
name = sprintf('../SkirmantasData/EnergiesCh37/energiesCh%iMpNNOTintersectNMI147.txt',ich);
